const benefits = [
  {
    ...
    desc: "K Line ME hires 1–2 top designers exclusively from Academy graduates per batch. This is the only pathway into our design team.",
  },
  {
    icon: (
      <svg className="w-10 h-10 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    title: '12-Month Alumni Webinar',
    desc: 'Monthly live case-discussion webinars with faculty for 12 months after graduation. Complex cases, troubleshooting, and peer review.',
  },
]
